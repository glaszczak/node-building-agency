...
app.get("/contractors", async (req, res) => {
    const getContractors = await readContracotrs()
    res.render("contractors/index", { contractors: getContractors })
});

app.get("/buildings", async (req, res) => {
    const getBuildings = await getBuildings()
    res.render("buildings/index", { buildings: getBuildings })
});
