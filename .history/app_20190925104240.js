...
async function getBookings() {
    try {
        ...
        results.map((currentValue) => {
            resArr.push(`${currentValue.fullName} - Works at: ${currentValue.address} -
            from: ${date.format(currentValue.fromDate, 'YYYY/MM/DD')}
            until: ${date.format(currentValue.toDate, 'YYYY/MM/DD')}`)
        })
